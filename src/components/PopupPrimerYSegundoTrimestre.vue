      ...
      <v-card>
        ...
        <v-card-text>
          <v-card ref="form" width="5000px">
            ...
            >
            <v-divider></v-divider>
            <v-card-subtitle><h3 class ="font-weight-regular">4.9 Recordatorio 24 horas</h3></v-card-subtitle>
            <v-container>
              <v-simple-table>
    ...
    return {
      ...
      itemsNivelEducativo: [
        ...
        itemsIngresoIndividual: [
          { nivel: '0 - 2.200', valor: '0' },
          { nivel: '2.200 - 4.400', valor: '1' },
          { nivel: '4.400 - 6.600', valor: '2' },
          { nivel: '6.600 - 13.000', valor: '3' },
          { nivel: '13.000 - 25.000', valor: '4' },
          { nivel: 'Más de 25.000', valor: '5' },
        ],
        itemsIngresoTotal: [
          { nivel: '0 - 16.000', valor: '0' },
  ...
  methods: {
    ...
    completarValoresDefault() {
      ...
      if (this.encuesta.cuantosEmbarazoAntes === null || this.encuesta.cuantosEmbarazoAntes === undefined)
        this.encuesta.cuantosEmbarazoAntes = 0;
